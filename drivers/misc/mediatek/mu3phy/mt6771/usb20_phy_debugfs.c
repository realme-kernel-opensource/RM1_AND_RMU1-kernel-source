...
void mtk_usb_phy_tuning(void)
{
	#ifdef VENDOR_EDIT
	/* Qiao.Hu@BSP.BaseDrv.CHG.Basic, 2017/12/16, mtk patch for otg eye picture*/
	if(is_project(OPPO_17331) || is_project(OPPO_17197) || is_project(OPPO_17061) || is_project(OPPO_17175) || is_project(OPPO_18311) || is_project(OPPO_18011)|| is_project(OPPO_18611)) {
		if(otg_is_exist ==1) {
