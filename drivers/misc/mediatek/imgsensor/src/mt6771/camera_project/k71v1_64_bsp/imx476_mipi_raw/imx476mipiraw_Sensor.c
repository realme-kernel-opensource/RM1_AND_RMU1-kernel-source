...
static void sensor_init(void)
{
	...
	write_cmos_sensor_8(0x3C7F, 0x03);
	...
	write_cmos_sensor_8(0x68B0, 0x80);
	...
	write_cmos_sensor_8(0x68D4, 0xA0);
	write_cmos_sensor_8(0x68DC, 0x15);
	write_cmos_sensor_8(0x68DD, 0x40);
	write_cmos_sensor_8(0x68E5, 0x2A);
	write_cmos_sensor_8(0x68E6, 0x80);
	...
	write_cmos_sensor_8(0xA862, 0xFF);
	write_cmos_sensor_8(0xA865, 0xFF);
...
{
	write_cmos_sensor_8(0x3178, 0x10);
	write_cmos_sensor_8(0x317A, 0x00);
	write_cmos_sensor_8(0x317B, 0x20);
	...
	write_cmos_sensor_8(0x37F8, 0x00); /*Flicker start*/
	...
	write_cmos_sensor_8(0X37F5, 0x88);
	write_cmos_sensor_8(0X37F6, 0x00);
	write_cmos_sensor_8(0X37F7, 0x1B); /*Flicker end*/

	write_cmos_sensor_8(0x0B00, 0x01); /*lsc enable*/
	write_cmos_sensor_8(0x323A, 0x01); /*enable STATS data*/
	write_cmos_sensor_8(0x323B, 0x01);
	write_cmos_sensor_8(0x323C, 0x01);

	write_cmos_sensor_8(0x7343, 0x00);
	write_cmos_sensor_8(0x37E4, 0x0B); /* AEHIST_AREA size */
	write_cmos_sensor_8(0x37E5, 0x40);
	write_cmos_sensor_8(0x37E6, 0x08);
	write_cmos_sensor_8(0x37E7, 0x6C);

	write_cmos_sensor_8(0xB734, 0x00); /* AEHIST_LINER_AUTO_THRESH 0:manual 1:auto */
	write_cmos_sensor_8(0xB736, 0x00); /*AEHIST_LINEAR_LOWER_TH*/
	write_cmos_sensor_8(0xB737, 0x00); /*AEHIST_LINEAR_LOWER_TH*/
	write_cmos_sensor_8(0xB738, 0x03); /*AEHIST_LINEAR_UPPER_TH*/
	write_cmos_sensor_8(0xB739, 0xFF); /*AEHIST_LINEAR_UPPER_TH*/

	write_cmos_sensor_8(0xB73A, 0x01); /* AEHIST_LOG_AUTO_THRESH 0:manual 1:auto */
	write_cmos_sensor_8(0xB73C, 0x00); /*AEHIST_LOG_LOWER_TH*/
	write_cmos_sensor_8(0xB73D, 0x00); /*AEHIST_LOG_LOWER_TH*/
	write_cmos_sensor_8(0xB73E, 0xFF); /*AEHIST_LOG_UPPER_TH*/
	write_cmos_sensor_8(0xB73F, 0xFF); /*AEHIST_LOG_UPPER_TH*/
	...
	write_cmos_sensor_8(0x0341, 0xAA);
...
static kal_uint32 return_lot_id_from_otp(void)
{
	...
	if (sensor_chip_id == 0x550) {
		...
		LOG_INF("This is 0.91cut version\n");
		return IMX476_SENSOR_ID;
	}
	return 0;
}
