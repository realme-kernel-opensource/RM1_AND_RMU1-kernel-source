...
#endif
static kal_uint16 imx576_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
kal_uint16 addr_data_pair_init_imx576[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x3C7E, 0x01,
	0x3C7F, 0x04,
...
kal_uint16 addr_data_pair_init_for_90cut_imx576[] = {
	0x9200, 0xFF,
	0x9201, 0xFF,
	0x9202, 0xFF,
	0x9203, 0xFF,
...
kal_uint16 addr_data_pair_preview_3HDR_imx576[] = {
	...
	0xB734, 0x00,
	0xB736, 0x00, /*AEHIST_LINEAR_LOWER_TH*/
	0xB737, 0x00, /*AEHIST_LINEAR_LOWER_TH*/
	0xB738, 0x03, /*AEHIST_LINEAR_UPPER_TH*/
	0xB739, 0xFF, /*AEHIST_LINEAR_UPPER_TH*/

	/* AEHIST_LOG_AUTO_THRESH 0:manual 1:auto */
	0xB73A, 0x01,
	0xB73C, 0x00, /*AEHIST_LOG_LOWER_TH*/
	0xB73D, 0x00, /*AEHIST_LOG_LOWER_TH*/
	0xB73E, 0xFF, /*AEHIST_LOG_UPPER_TH*/
	0xB73F, 0xFF, /*AEHIST_LOG_UPPER_TH*/
...
kal_uint16 addr_data_pair_preview_imx576[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x18,
...
kal_uint16 addr_data_pair_capture_imx576[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x18,
...
{
	LOG_INF("E\n");
	imx576_table_write_cmos_sensor(addr_data_pair_init_imx576,
							   sizeof(addr_data_pair_init_imx576) / sizeof(kal_uint16));
	LOG_INF("L\n");
} /*	sensor_init  */
...
static void sensor_init_for_90cut(void)
{
	/*extra setting*/
	LOG_INF("E\n");
	imx576_table_write_cmos_sensor(addr_data_pair_init_for_90cut_imx576,
		sizeof(addr_data_pair_init_for_90cut_imx576) / sizeof(kal_uint16));
}
#endif
...
{
	LOG_INF("E\n");
	imx576_table_write_cmos_sensor(addr_data_pair_preview_3HDR_imx576,
		sizeof(addr_data_pair_preview_3HDR_imx576) / sizeof(kal_uint16));
	LOG_INF("L\n");
...
static void preview_setting(void)
{
	...
	imx576_table_write_cmos_sensor(addr_data_pair_preview_imx576,
		sizeof(addr_data_pair_preview_imx576) / sizeof(kal_uint16));
	#else
	LOG_INF("E binning_3hdr_setting\n");
	imx576_table_write_cmos_sensor(addr_data_pair_preview_3HDR_imx576,
		sizeof(addr_data_pair_preview_3HDR_imx576) / sizeof(kal_uint16));
	#endif
	LOG_INF("L\n");
...
static void capture_setting(kal_uint16 currefps, kal_bool stream_on)
{
	...
	/* capture setting */
	#if USE_REMOSAIC
	imx576_table_write_cmos_sensor(addr_data_pair_capture_imx576,
						   sizeof(addr_data_pair_capture_imx576) / sizeof(kal_uint16));
	#else
	preview_setting();
	#endif
	LOG_INF("L!\n");
