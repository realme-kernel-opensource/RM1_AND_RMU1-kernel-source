...
#ifndef VENDOR_EDIT
//Xiaomin.Yang@Connectivity.BT.Btif.DMA, 2018/04/21,
//Modify for [1332974], Set dma rx threshold 1 only for project 17061
#define DMA_RX_THRE(n) ((n) * 3 / 4)	/*Rx Trigger Level */
#else /* VENDOR_EDIT */
#ifdef CONFIG_MTK_BT_DMA_CONFIG
#define DMA_RX_THRE(n) (1)            /*Rx Trigger Level For Project 17061*/
#else
#define DMA_RX_THRE(n) ((n) * 3 / 4)	/*Rx Trigger Level */
#endif
#endif /* VENDOR_EDIT */
