...
static int vpu_enable_regulator_and_clock(int core)
{
	...
	LOG_INF("[vpu_%d] regulator getted  %d+\n", core, is_regulator_getted);
	LOG_INF("before setting regulator_get_voltagereg_id= %d uV\n", regulator_get_voltage(buck_vimvo));
...
#define DISABLE_VPU_MTCMOS(clk) \
	...
	default:
		...
		LOG_INF("[vpu_%d]DISABLE_VPU_MTCMOS - mtcmos_vpu_core0_shutdown\n", core);
		break;
	case 1:
	    ...
	    LOG_INF("[vpu_%d]DISABLE_VPU_MTCMOS - mtcmos_vpu_core1_shutdown\n", core);
		break;
	case 2:
	    ...
	    LOG_INF("[vpu_%d]DISABLE_VPU_MTCMOS - mtcmos_vpu_core2_shutdown\n", core);
		break;
	}
	...
	LOG_INF("[vpu_%d]DISABLE_VPU_MTCMOS - mtcmos_vpu_vcnn\n", core);
	...
	LOG_INF("[vpu_%d]DISABLE_VPU_MTCMOS - mtcmos_vpu_vcore\n", core);
	...
	LOG_INF("[vpu_%d]DISABLE_VPU_MTCMOS - mtcmos_mm0\n", core);
