	...
	switch(get_project()) {
		...
		case OPPO_17175:
			if (get_PCB_Version() < HW_VERSION__14) {
				if ((id1 == 1) && (id2 == 1) && (operator == OPERATOR_17175_ALL_BAND
					|| operator == OPERATOR_17176_MOBILE)) {
				    snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
				} else if ((id1 == 1) && (id2 == 0) && (operator == OPERATOR_17179_FOREIGN
					|| operator == OPERATOR_17173_ALL_BAND || operator == OPERATOR_17180_FOREIGN)) {
				    snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
				} else if ((id1 == 0) && (id2 == 1) && (operator == OPERATOR_17171_ASIA_SIMPLE
					|| operator == OPERATOR_17172_ASIA)) {
				    snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
				} else {
					snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "rf-unmatch");
				}
			} else {
				if ((id1 == 1) && (id2 == 1) && (operator == OPERATOR_17171_ASIA_SIMPLE
					|| operator == OPERATOR_17172_ASIA)) {
				    snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
				} else if ((id1 == 1) && (id2 == 0) && (operator == OPERATOR_17179_FOREIGN
					|| operator == OPERATOR_17180_FOREIGN || operator == OPERATOR_17173_ALL_BAND)) {
				    snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
				} else if ((id1 == 0) && (id2 == 1) && (operator == OPERATOR_17175_ALL_BAND
					|| operator == OPERATOR_17176_MOBILE)) {
				    snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
				} else {
					snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "rf-unmatch");
			...
			break;
        case OPPO_17111:
			if(operator == OPERATOR_FOREIGN_TAIWAN_17111 ){
				if ((id1 == 1) && (id2 == 0))
		...
		case OPPO_18311:
			...
			break;
        case OPPO_18611:
		    if (((id1 == 1) && (id2 == 1)) && ((operator == OPERATOR_18611_REALME_INDIA) 
                                   ||(operator == OPERATOR_18611_REALME_INDIA_DDR4))) {
				snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "audio-match");
            } else if (((id1 == 0) && (id2 == 0))  && ((operator == OPERATOR_18611_REALME_ALL_BAND) 
			           || (operator == OPERATOR_18611_REALME_VIETNAM_ALL_BAND))) {
                snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "audio-match");
            } else {
                snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "audio-unmatch");
            }
